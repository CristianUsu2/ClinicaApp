          ...
          >
              ...
              <>
                    ...
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          Ingresa para asignar citas con tus especialistas o
                  ...
                  <Card sx={{ maxWidth: 345 }}>
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          Ingresa para visualizar los examanes asignados por los
                          profesionales
                        </Typography>
                      </CardContent>
                    </CardActionArea>
                ...
                <Grid
                  ...
                  mt={3}
                  mb={3}
                  onClick={() => router.push("/HistoriaClinica")}
                >
                  <Card sx={{ maxWidth: 345 }}>
                    <CardActionArea>
                      <CardMedia
                  ...
                  <Card sx={{ maxWidth: 345 }}>
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          Ingresa para visualizar los usuarios y puedes crear
                          nuevos usuarios
                        </Typography>
                      </CardContent>
                    </CardActionArea>
                  ...
                  <Card sx={{ maxWidth: 345 }}>
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          Ingresa para visualizar los profesionales y registrar
